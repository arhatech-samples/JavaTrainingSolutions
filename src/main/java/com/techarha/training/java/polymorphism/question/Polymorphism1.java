package com.techarha.training.java.polymorphism.question;

/**
 * @question Create an inheritance hierarchy of Rodent: Mouse, Gerbil, Hamster, etc. In the base class, provide methods
